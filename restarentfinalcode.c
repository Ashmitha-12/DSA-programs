...
struct node *headb = NULL, *tailb = NULL;
...
void adminmenu()
{
    ...
    printf("\t\t\t\t\t\t\t3. Display order menu\n");
    printf("\t\t\t\t\t\t\t4. Add todays specail menu\n");
    printf("\t\t\t\t\t\t\t5. Display today special menu\n");
...
void customermenu()
{
    ...
    printf("\t\t\t\t\t\t\t2. Place special order\n");
    printf("\t\t\t\t\t\t\t3. Display today special menu\n");
    printf("\t\t\t\t\t\t\t4. View your ordered items\n");
    printf("\t\t\t\t\t\t\t5. Delete an item from order\n");
    printf("\t\t\t\t\t\t\t6. Display final bill\n");
...
struct node* createadmin1(struct node *head,int data, char foodname[25], float price)
{
    newnode = (struct node*)malloc(sizeof(struct node));
...
struct node* createcustomer1(struct node *head,int data,int quantity)
{
    newnode = (struct node*)malloc(sizeof(struct node));
    ...
    {
        newnode->data = data;
        newnode->price = quantity*(temp2->price);
        newnode-> quantity = quantity;
        strcpy(newnode->foodname,temp2->foodname);
        newnode->next = NULL;
        newnode->prev = NULL;
...
void specialmenu()
{
    printf("\t\t\t\t\t\t\tThe todays special items are\n:");
    ...
    printf("\t\t\t\t\t\t\tEnter price: ");
    scanf("%f",&price);
    ptr = createadmin1(ptr, num, name, price);
    ...
    while(1)
    {
        ...
        switch (opt)
        {
            ...
            case 2:
                ...
                int quantity1;
                scanf("%d",&quantity1);
                headc = createcustomer1(headc, n1, quantity1);
                break;
            case 3:
            	printf("\t\t\t\t\t\t\t\t ###todays special menu###\n");
            	display(headc);
